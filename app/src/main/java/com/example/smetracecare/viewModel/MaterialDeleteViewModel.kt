...
class MaterialDeleteViewModel : ViewModel() {
    ...
    fun DeleteMaterial(token:String, materialId: String) {
        _loading.value = true
        val api = ApiConfig.getApiService().deleteMaterial(token, materialId)
