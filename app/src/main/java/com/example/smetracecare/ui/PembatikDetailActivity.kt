...
class PembatikDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.editButton.setOnClickListener(View.OnClickListener {
            val intent = Intent(this@PembatikDetailActivity, SupplierProductEditActivity::class.java)
            intent.putExtra(EXTRA_DATA, detailStory) // Meneruskan materialId ke SupplierProductEditActivity
            startActivity(intent)
        })

        binding.btnBack.setOnClickListener(View.OnClickListener {
            startActivity(Intent(this@PembatikDetailActivity, SupplierHomeFragment::class.java))
        })
