...
class ListProductAdapter(private val productList: List<ProductDetail>) :
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val listProduct = productList[position]
        val bitmap = decodeBase64ToBitmap(listProduct.image)
        if (bitmap != null) {
        ...
        holder.name.text = listProduct.name
